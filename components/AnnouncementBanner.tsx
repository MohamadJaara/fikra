  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="relative z-10 mx-auto flex items-center gap-3 px-4 py-2.5 md:px-6">
            <motion.div
            ...
            <div className="flex-1 min-w-0 flex items-center gap-2">
              ...
              <motion.p
                ...
                className="hidden sm:block text-sm text-white/85 truncate"
              >
            ...
            <motion.button
              ...
              className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15 text-white/80 hover:bg-white/25 hover:text-white transition-colors backdrop-blur-sm"
            >
